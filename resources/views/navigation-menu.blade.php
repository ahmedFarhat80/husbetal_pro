<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <p style="display: none">{{ $gurd = auth()->guard()->name ?? 'web' }}</p>
                    @if ($gurd != 'doctor')
                        @can('View-Admins')
                        ...
                        @endcan
                    @else
                        <x-nav-link href="{{ route('time.doctor') }}" :active="request()->routeIs('time.doctor')">
                            {{ __('Add working hours') }}
                        </x-nav-link>

                        <x-nav-link href="{{ route('doctor.booking') }}" :active="request()->routeIs('doctor.booking')">
                            {{ __('Reservations Schedule') }}
                        </x-nav-link>
                    @endif
                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            @endphp
                            <x-dropdown-link href="{{ route('lang', $lang_Locale) }}">
                                @if (app()->getLocale() == 'ar')
                                    الانجليزية
                                @else
                                    العربية
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @endcan
            @can('View-Sections')
                <x-responsive-nav-link href="{{ route('Section') }}" :active="request()->routeIs('Section')">
                    {{ __('Sections') }}
                </x-responsive-nav-link>
            @endcan
            @can('View-Doctors')
