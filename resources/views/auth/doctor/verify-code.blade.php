...
<body dir="@if (App()->getLocale() == 'ar') rtl @else ltr @endif">
            ...
            <div class="col-md-6 mx-auto">
                ...
                <div class="login-container">
                    ...
                    <form method="POST" action="{{ route('ConfirmsendVerification') }}">
                        ...
                        <button type="button" class="btn btn-primary mt-3" onclick="ConfirmsendVerification()">
    ...
    <script>
        ...
        function sendVerificationCode() {
            axios.post('/doctor/update/profile/re-sendVerification', {
                ...
                .then(function(response) {
                    ...
                    // window.location.href = "/categories"; // التحويل والانتقال
                })
