...
class Mobile2000Service
{
    ...
    public static function send($code, $phone)
    {
        ...
        $soap_request   = "username=Yone App1&password=bp55eLG6&token=wMd9zEbn0jk3SRwT3vOpYfKD&sender=Military hospital&message=" . $message  . "&dst=" . $dst . "&type=text&coding=default&datetime=now";
